...
| `data/fiscal-periods.csv` | Optional. `label,start,end` for each fiscal period; when present, dates are bucketed by fiscal period instead of calendar month, to match the monthly report. Not yet supplied. |
